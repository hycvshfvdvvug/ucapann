...
<head>
  ...
  <title>Selamat Ulang Tahun Amel!</title>
  <style>
    body {
      margin: 0;
      padding: 0;
...
<body>
  ...
  <div class="foto-container">
    <img src="488077064_1870935533720326_3006000180534860689_n.jpg" alt="Foto Amel">
  ...
  <script>
    function playMusic() {
      ...
      audio.play().catch(err => {
        alert("Klik lagi ya, browser butuh izin untuk putar musik 🎵");
        console.error(err);
      });
    }
  </script>
